...
public class HomePageDao {
    ...
    public void add(Contact contact, String username) throws SQLException {
        ...
        queryRunner.update(sql.toString(), contact.getId(), contact.getName(), contact.getSex(),
                contact.getTelephoneNumber(), contact.getAddress(), contact.getqqNumber(), contact.getUgroup());
    }
    ...
    public void update(Contact contact, String username) throws SQLException {
        ...
        StringBuilder sql = new StringBuilder(
                "update " + username + " set name=?,sex=?,telephoneNumber=?,address=?,qqNumber=?,ugroup=? where id=?");
    ...
    public List<Contact> getList(Page<Contact> page, String username) throws SQLException {
        ...
        List<Contact> list = queryRunner.query(sql.toString(), new BeanListHandler<Contact>(Contact.class),
